...
- Write speeds, read speeds and idle CPU usage have improved significantly on Linux builds.
...
### Performance
* Performance improvements on Linux builds
  - Write speeds have increased by approximately 50%.
  - Read speeds have also improved by approximately 15% in some cases.
  - Idle CPU usage is lower than before.
